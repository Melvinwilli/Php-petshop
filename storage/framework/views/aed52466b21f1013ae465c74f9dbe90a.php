...
<head>
    ...
    <title>Tambah Kategori - PetCare</title>
    ...
    <div class="page-container">
        ...
        <div>
            ...
            <p class="page-subtitle">
                Tambahkan kategori baru untuk mengelompokkan hewan.
            </p>
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        <div class="form-help">
                            Contoh kategori: Reptile, Fish, Mammal, Bird.
                        </div>
    ...
    <form action="<?php echo e(route('category.store')); ?>" method="POST">
        ...
        <p>
            ...
            <textarea
                ...
                rows="4"
                cols="40"
                placeholder="Contoh: Hewan jenis kucing"
            ><?php echo e(old('description')); ?></textarea>
        </p>
...
</html> --><?php /**PATH C:\Users\Admin\Documents\melvinlaravel\petshop\resources\views/admin/category/create.blade.php ENDPATH**/ ?>