    ...
    <div class="page-container">
        ...
        <div class="form-card">
            ...
            <div class="form-body">
                ...
                <form
                    action="<?php echo e(route('penitipan.update', $penitipan->id)); ?>"
                    method="POST"
                >
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('name', $penitipan->name)); ?>"
...
unset($__errorArgs, $__bag); ?>"
                                >
                                    ...
                                    <option
                                        value="Laki-laki"
                                        <?php echo e(old('gender', $penitipan->gender) == 'Laki-laki' ? 'selected' : ''); ?>
                                    ...
                                    <option
                                        value="Perempuan"
                                        <?php echo e(old('gender', $penitipan->gender) == 'Perempuan' ? 'selected' : ''); ?>
                            ...
                            >
                                ...
                                <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $member): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <option
                                        ...
                                        <?php echo e(old('member_id', $penitipan->member_id) == $member->id ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('weight', $penitipan->weight)); ?>"
                                    step="0.01"
                                    min="0"
                                    placeholder="5.5"
                                >
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('height', $penitipan->height)); ?>"
                                    step="0.01"
                                    min="0"
                                    placeholder="40"
                                >
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('age', $penitipan->age)); ?>"
                                    min="0"
                                    placeholder="2"
                                >
                            ...
                            >
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <option
                                        ...
                                        <?php echo e(old('category_id', $penitipan->category_id) == $category->id ? 'selected' : ''); ?>
...
<form action="<?php echo e(route('penitipan.update', $penitipan->id)); ?>" method="POST">
...
</html> --><?php /**PATH C:\Users\Admin\Documents\melvinlaravel\petshop\resources\views/penitipan/edit.blade.php ENDPATH**/ ?>