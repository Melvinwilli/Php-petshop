            ...
            <div class="table-responsive">
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        {{-- SORT ID TERKECIL KE TERBESAR --}}
                        @forelse($pricelists->sortBy('id') as $pricelist)
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <span class="price">
                                        ...
                                        Rp {{ number_format($pricelist->harga_harian, 0, ',', '.') }}
                                ...
                                <td>
                                    ...
                                    <span class="price">
                                        ...
                                        Rp {{ number_format($pricelist->harga_mingguan, 0, ',', '.') }}
                                ...
                                <td>
                                    ...
                                    <span class="price">
                                        ...
                                        Rp {{ number_format($pricelist->harga_bulanan, 0, ',', '.') }}
                                ...
                                <td>
                                    ...
                                    <div class="action-buttons">
                                        ...
                                        <form action="{{ route('pricelist.destroy', $pricelist->id) }}"
                                              method="POST"
...
<a href="{{ route('pricelist.create') }}">+ Tambah Pricelist</a>
        ...
        @forelse($pricelists as $pricelist)
            ...
            <tr>
                ...
                <td>
                    ...
                    <form
                        action="{{ route('pricelist.destroy', $pricelist->id) }}"
                        method="POST"
                        style="display:inline;"
